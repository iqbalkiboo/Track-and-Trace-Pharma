...
import ModalImportExcel from "@/components/modal/modal-import-excel.vue"
...
function getActionOptions(status: string) {
    const options = [
        {
            label: "Detail Serialisasi Turunan",
            key: "detail",
            icon: renderIcon(SearchOutline),
        },
        {
            label: "Cetak Serialisasi Turunan",
            key: "print",
            icon: renderIcon(PrintOutline),
        },
        { label: "Tambah Serialisasi Turunan", key: "create", icon: renderIcon(Add) },
        {
            label: "Batalkan Serialisasi Turunan",
            key: "cancel",
            icon: renderIcon(CloseOutline),
        },
        { label: "Lacak PK Turunan", key: "lacak", icon: renderIcon(LocationOutline) },
    ]
...
<template>
    <n-space vertical :size="0">
        <div class="card-tnt">
            <n-space>
                <n-h2 style="margin-bottom: 16px">PK Turunan</n-h2>
            </n-space>
            <n-space>
                <n-button
