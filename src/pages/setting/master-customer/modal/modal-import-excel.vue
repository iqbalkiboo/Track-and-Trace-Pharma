...
function handleSubmit() {
  ...
  masterCustomerModel.importCustomer(formData).then(() => {
      ...
      <n-space vertical :size="25">
        ...
        <n-space vertical :size="14">
          <n-space vertical :size="8">
            ...
            <a href="/assets/xlsx/master-customer.xlsx" download style="font-size: 13px; color: #219653">Download Contoh File</a>
          </n-space>
        </n-space>
